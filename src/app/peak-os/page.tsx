...
export default async function PeakOsPage() {
  ...
  return record ? <Cockpit state={record.state} receivedAt={record.received_at} currentTime={currentEpochMilliseconds()} canAdminister={canAdminister} /> : <Offline canAdminister={canAdminister} />;
}
