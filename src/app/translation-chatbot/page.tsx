...
export const metadata: Metadata = {
  title: "LINE 翻譯助理｜印尼文繁體中文雙向翻譯",
  description:
    "LINE101Chat LINE 翻譯助理支援 Indonesian ⇄ Traditional Chinese，適合台灣雇主、移工、看護、工廠、仲介與家庭日常溝通。",
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_420px] lg:items-center">
          <div>
            ...
            <h1 className="mt-5 max-w-4xl text-4xl font-black leading-tight tracking-[0] text-slate-950 sm:text-5xl">
              LINE 翻譯助理：協助台灣雇主與印尼夥伴日常溝通
            </h1>
            <p className="mt-5 max-w-3xl text-lg leading-9 text-slate-600">
              直接在 LINE 裡支援印尼文與繁體中文雙向翻譯，讓雇主、移工、看護、工廠管理者、仲介與家庭可以用熟悉的方式溝通。
            </p>
          </div>
          <PresenterCallout
            imageKey="translation"
            label="適合日常使用"
            title="LINE 裡完成翻譯，不需要另外學新工具"
            body="適合需要頻繁跨語言溝通，但又希望操作方式簡單、直接在 LINE 裡使用的場景。"
          />
        </div>
      </section>
      ...
      <section className="bg-white px-5 py-16 sm:px-8 lg:px-10">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
          <SectionHeading
            eyebrow="服務能力"
            title="為台灣現場情境設計"
            description="翻譯助理不追求複雜功能，而是讓日常句子、提醒、工作安排與照護溝通能更快被理解。"
          />
        ...
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <p className="mt-4 text-base leading-8 text-slate-600">
              使用者只要把訊息貼到 LINE，bot 會回傳另一種語言的自然翻譯。正式導入時可再加上紀錄、額度與使用者管理。
            </p>
          </div>
