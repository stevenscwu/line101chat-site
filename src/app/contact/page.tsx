...
export const metadata: Metadata = {
  ...
  description:
    "聯絡 LINE101Chat，預約 30 分鐘需求評估、RAG 知識助理 Demo、LINE 翻譯助理或本地端私有化部署討論。",
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_420px]">
          <div>
            <SectionHeading
              eyebrow="聯絡我們"
              title="聯絡我們"
              description="如果你正在評估 RAG 知識助理、LINE 翻譯助理或本地端部署，歡迎先用一封信描述目前的文件與使用場景。"
            />
            <div className="mt-8">
              <ContactForm />
            </div>
          ...
          <div className="space-y-5">
            <PresenterCallout
              imageKey="contact"
              label="30 分鐘需求評估"
              title="先聊清楚，再決定是否做 PoC"
              body="我們會協助確認文件狀況、使用者場景、LINE 或網站入口，以及 PoC 需要準備的資料。"
            />
