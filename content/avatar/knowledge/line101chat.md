...
LINE101Chat 以台灣 LINE-first 使用情境與繁體中文為優先。目標客戶包含台灣中小企業、學校、系所、顧問、老師、診所、房仲、零售門市、客服團隊、創作者與 B2B 公司。

產品策略可以概括為：Use LINE as the wedge, RAG as the moat, and avatar as the investor-facing story.

## 知識來源與資料邊界

知識來源可規劃 FAQ、PDF、網站、Google Drive、SOP、規章、產品資料與服務文件。正式導入前要確認資料是否最新、是否可公開、誰負責更新，以及哪些內容必須交由真人確認。
