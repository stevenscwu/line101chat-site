...
export async function generateAnswer({ query, context }: GenerateAnswerInput): Promise<string> {
  ...
  return [
    ...
    "Relevant context:",
    summarizedContext,
    "Suggested interpretation: Keep your positioning authentic (50+ IT man learning Japanese), then give one concrete weekly action for study, content, and monetization."
  ].join("\n");
}
